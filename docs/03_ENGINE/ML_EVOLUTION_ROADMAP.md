...
- **P7.1 — `shot_dominance`** (singurul feature implementat în această rundă) — design complet: `P7_1_DESIGN_SHOT_DOMINANCE_2026-07-15.md`. **P7.1A — Data Quality Audit** (`P7_1A_DATA_QUALITY_AUDIT_2026-07-15.md`, cerut explicit de Chief Architect înainte de orice cod): coverage 92,7% (identic cu precedentul `foul_diff` la acceptare), distribuție cu răspândire reală (nu concentrată în 0), nicio corelație ≥0,9 cu feature existent (cea mai mare: `corner_dominance` r=0,687), Mutual Information 1,44× mai mare ca `corner_dominance` și 3,19× mai mare ca `foul_diff` (ambele deja acceptate) — **verdict GO**. Status: **Planned**, design + audit închise, implementare (ablație oficială walk-forward) neîncepută, așteaptă aprobarea explicită a Chief Architect.
